// src/components/studio/CardPreview/Layouts/SingleBottom.tsx
'use client'
...
export function SingleBottom({ style, cardData, accentBar }: { style: Template['style'], cardData: CardData, accentBar: React.ReactNode }) {
