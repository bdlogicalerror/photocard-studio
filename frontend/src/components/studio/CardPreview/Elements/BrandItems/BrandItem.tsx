...
export function BrandItem({ id, label, defaultIcon, dataKey, style = {}, focusTarget }: BrandItemProps) {
    ...
    >
      ...
      {showSettings && isInteractive && (
        <div 
          ...
          className="absolute bottom-full left-0 mb-2 w-56 bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl p-3 z-[200] flex flex-col gap-3 cursor-default"
